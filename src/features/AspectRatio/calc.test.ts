...
describe('calculateAspectRatioValues', () => {
  it('should calculate pxWidth correctly when ratioW is changed', () => {
  ...
  it('should calculate pxHeight correctly when ratioH is changed', () => {
  ...
  it('should calculate pxHeight correctly when pxWidth is changed', () => {
  ...
  it('should calculate pxWidth correctly when pxHeight is changed', () => {
